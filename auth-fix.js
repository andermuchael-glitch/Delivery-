import "./tools.js?v=113";
import "./entrega365-features.js?v=113";
import "./session-policy.js?v=113";
import "./entrega365-theme-v2.js?v=113";
import "./entrega365-pro.js?v=113";
import "./pro-sync.js?v=113";
import "./establishments.js?v=113";
...
const SESSION="dcv2:session",FULL_LOGO="./logo-entrega365.jpg?v=113",ICON_LOGO="./app-icon.svg?v=113";
let redirectProcessing=true;
function loadMobileCss(){if(document.querySelector('link[data-e365-mobile-css]'))return;const l=document.createElement('link');l.rel='stylesheet';l.href='./mobile-layout-fix.css?v=113';l.dataset.e365MobileCss='1';document.head.appendChild(l)}
...
import("./drive-backup.js?v=113").then(m=>m.initDriveBackup(auth)).catch(e=>console.warn("Drive backup indisponível",e));
