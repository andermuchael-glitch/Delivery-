...
const STATIONS={
 atlantida:{name:'Atlântida Florianópolis',freq:'100.9 FM · Florianópolis / SC',embed:'https://www.radios.com.br/aovivo/radio-atlantida-1009-fm/9756',source:'https://www.radios.com.br/aovivo/radio-atlantida-1009-fm/9756'},
 jp:{name:'Jovem Pan Itajaí',freq:'94.1 FM · Itajaí / SC',embed:'https://play.radios.com.br/13365',source:'https://play.radios.com.br/13365'},
...
function radioScreen(){const s=STATIONS[radioCurrent];return `<div class="radio-screen"><div class="radio-head"><div class="radio-head-icon">◉</div><div><h1>Rádio</h1><p>Ouça enquanto trabalha</p></div></div><div class="radio-player"><div class="state" id="radioState">PRONTO</div><h2 id="radioName">${s.name}</h2><div class="freq" id="radioFreq">${s.freq}</div><button class="play-main" id="radioPlay">▷ &nbsp; Tocar no app</button><div class="volume"><span>🔊</span><input id="radioVolume" type="range" min="0" max="1" step="0.01" value="0.85"></div></div><div id="embeddedArea"></div><div class="section-label">ESTAÇÕES</div>${stationButton('atlantida')}${stationButton('jp')}${stationButton('trans')}<div class="notice" style="margin-top:14px">Usei uma fonte alternativa de streaming para as rádios que não estão aceitando o stream direto. O player fica dentro desta aba.</div></div>`}
