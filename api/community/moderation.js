...
// Server-side only: the API remains the final gate even if the client is modified.
...
const RULES = [
  {
    ...
    words: [
      ...
      'votacao','votação','lula','bolsonaro','pt','pl','psol','mdb','psdb','podemos',
      'stf','supremo tribunal federal','direita','esquerda','jair','petista','bolsonarista'
    ]
  },
  {
...
export function moderationNotice() {
  return 'A Comunidade não permite conteúdo político, sexual ou pornográfico, linguagem obscena, ameaças, discriminação ou outras condutas inadequadas.';
}
