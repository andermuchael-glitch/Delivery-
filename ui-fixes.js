...
if(cmdCard.dataset.sorted!=='1'){const entries=[...cmdCard.querySelectorAll(':scope > .entry')];if(entries.length){entries.reverse().forEach(e=>cmdCard.appendChild(e));if(table)cmdCard.insertBefore(table,cmdCard.querySelector(':scope > .entry'));cmdCard.insertBefore(add,table||cmdCard.querySelector(':scope > .entry')||null)}cmdCard.dataset.sorted='1'}
moveKmToBottom(main)}
